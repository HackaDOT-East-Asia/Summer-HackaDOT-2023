...
impl pallet_publish_platform::Config for Runtime {
	...
	type Limit = u128;
	type Balance = Balance;
	type WeightInfo = pallet_publish_platform::weights::SubstrateWeight<Runtime>;
}
...
parameter_types! {
	...
	pub RuntimeBlockWeights2: BlockWeights = BlockWeights::builder()
		...
		.build_or_panic();
	pub DeletionWeightLimit: Weight = RuntimeBlockWeights2::get()
		.per_class
		.get(DispatchClass::Normal)
		.max_total
		.unwrap_or(RuntimeBlockWeights2::get().max_block);
